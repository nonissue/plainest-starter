 ...
 * @param {string} end - (optional)  ending_before is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with obj_bar, your subsequent call can include ending_before=obj_bar in order to fetch the previous page of the list.
...
exports.handler = async event => {
  ...
  let { limit, starting_from: start, ending_before: end } = event.queryStringParameters;
